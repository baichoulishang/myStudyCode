...
(function (a) {
    ...
    b(a, "error-messages.js", [a["parts/Globals.js"]], function (a) {
        a.errorMessages = {
            ...
            16: {title: "Highcharts already defined in the page", text: "\x3ch1\x3eHighcharts already defined in the page\x3c/h1\x3e\x3cp\x3eThis error happens if the \x3ccode\x3eHighcharts\x3c/code\x3e namespace already exists when loading\x3c/p\x3e\x3cp\x3eHighcharts or Highstock.\x3c/p\x3e\x3cp\x3eThis is caused by including Highcharts or Highstock more than once.\x3c/p\x3e\x3cp\x3eKeep in mind that the \x3ccode\x3eHighcharts.Chart\x3c/code\x3e constructor and all features of Highcharts are included in Highstock, so if using the \x3ccode\x3eChart\x3c/code\x3e and \x3ccode\x3eStockChart\x3c/code\x3e constructors in combination, only the \x3ccode\x3ehighstock.js\x3c/code\x3e file is required.\x3c/p\x3e"},
            ...
            18: {title: "The requested axis does not exist", text: "\x3ch1\x3eThe requested axis does not exist\x3c/h1\x3e\x3cp\x3eThis error happens when setting a series' \x3ccode\x3exAxis\x3c/code\x3e or \x3ccode\x3eyAxis\x3c/code\x3e property to point to an axis that does not exist.\x3c/p\x3e"},
            19: {title: "Too many ticks", text: "\x3ch1\x3eToo many ticks\x3c/h1\x3e\x3cp\x3eThis error happens when applying too many ticks to an axis, specifically when adding more ticks than the axis pixel length.\x3c/p\x3e\x3cp\x3eWith default value this won't happen, but there are edge cases, for example when setting axis categories and \x3ccode\x3exAxis.labels.step\x3c/code\x3e in combination with a long data range, when the axis is instructed to create a great number of ticks.\x3c/p\x3e"},
            ...
            21: {title: "Can't find Proj4js library", text: '\x3ch1\x3eCan\'t find Proj4js library\x3c/h1\x3e\x3cp\x3eUsing latitude/longitude functionality in Highmaps requires the \x3ca href\x3d"http://proj4js.org"\x3eProj4js\x3c/a\x3e library to be loaded.\x3c/p\x3e'},
            22: {title: "Map does not support latitude/longitude", text: '\x3ch1\x3eMap does not support latitude/longitude\x3c/h1\x3e\x3cp\x3eThe loaded map does not support latitude/longitude functionality. This is only supported with maps from the \x3ca href\x3d"https://code.highcharts.com/mapdata"\x3eofficial Highmaps map collection\x3c/a\x3e from version 1.1.0 onwards. If you are using a custom map, consider using the \x3ca href\x3d"https://proj4js.org"\x3eProj4js\x3c/a\x3e library to convert between projections.\x3c/p\x3e'},
            ...
            30: {title: "Invalid instrument", text: "\x3ch1\x3eInvalid instrument\x3c/h1\x3e\x3cp\x3eThis happens when you try to use a sonification instrument that is not valid. If you are using a predefined instrument, make sure your spelling is correct.\x3c/p\x3e"},
            31: {title: "Non-unique point or node id", text: "\x3ch1\x3eNon-unique point or node id\x3c/h1\x3e\x3cp\x3eThis error occurs when using the same \x3ccode\x3eid\x3c/code\x3e for two or more points or nodes.\x3c/p\x3e"},
    ...
    b(a, "modules/debugger.src.js", [a["parts/Globals.js"]], function (a) {
        ...
        b(a.Chart, "displayError", function (b) {
            ...
            e && e.displayErrors && (this.errorElements = [], d = f(d) ? "Highcharts error #" + d + ": " + a.errorMessages[d].title + a.errorMessages[d].text : d, e = this.chartWidth, c = this.chartHeight, this.errorElements[0] =
                b.rect(2, 2, e - 4, c - 4).attr({"stroke-width": 4, stroke: "#ff0000", zIndex: 3}).add(), this.errorElements[1] = b.label(d, 0, 0, "rect", null, null, !0).css({color: "#ffffff", width: e - 16, padding: 0}).attr({fill: "#ff0000", width: e, padding: 8, zIndex: 10}).add(), this.errorElements[1].attr({y: c - this.errorElements[1].getBBox().height}))
        });
